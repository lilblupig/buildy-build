    ...
    <div class="row justify-content-md-center">
      ...
      <div class="collapse col-md-auto g-0" id="pagenavlinks">
        <div class="nav flex-column flex-md-row">
          <a href="#about-section" class="nav-link quick-link">About</a>
          <a href="#estimator" class="nav-link quick-link">Estimator</a>
          <a href="#testimonials" class="nav-link quick-link">Testimonials</a>
        </div>
      </div>
    </div>
  </div>'
